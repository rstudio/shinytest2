...
`{shinytest2}` can be used with [interactive R Markdown documents](http://rmarkdown.rstudio.com/authoring_shiny.html) that use `runtime: shiny` or `server: shiny` (sometimes also referred to as Shiny documents).
