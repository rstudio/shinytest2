...
For an indepth discussion of expectations, see the [Robust testing vignette](./robust.Rmd).
TODO-barret
...
In many cases, instead of setting the random seed, it is more elegant to use an [output preprocessor](zz-faq.html#can-i-modify-the-input-and-output-values-that-are-recorded-in-snapshots).
...
<!-- TODO-barret; talk about variants
