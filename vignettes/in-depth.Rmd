...
Another way is to take a screenshot of your application. You can call `app$screenshot()` to take a screenshot of the application. This will display the screenshot as if it were a plot. (In RStudio, it will show in the Viewer pane.)
