...
* `old$getWindowSize()`, `old$setWindowSize(width, height)`: These methods have been renamed to `new$get_window_size()` and `new$set_window_size(width, height)`.
