...
This method has been renamed to `AppDriver$screenshot(file)`, and the `id` and `parent` parameters have been removed. To use a selector, set `AppDriver$screenshot(myfile, selector = ".custom-selector")` or `screenshot_args` directly.
