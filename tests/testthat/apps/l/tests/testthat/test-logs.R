...
test_that("App captures known debug messages", {
  ...
  #  [7] "{chromote}   JS info      09:38:33.75 shinytest2: jQuery not loaded yet"
  ...
  # [19] "{chromote}   JS info      09:38:33.97 shinytest2: busy"
  ...
  # [23] "{chromote}   JS info      09:38:34.00 shinytest2: idle"
  # [24] "{chromote}   JS websocket 09:38:34.00 recv {\"errors\":{},\"values\":{\"time\":\"1640097514\"},\"inputMessages\":[]}"
  # [25] "{chromote}   JS info      09:38:34.00 shinytest2: value time"
  ...
  # [29] "{chromote}   JS info      09:38:37.00 shinytest2: busy"
  ...
  # [33] "{chromote}   JS info      09:38:37.03 shinytest2: idle"
  # [34] "{chromote}   JS websocket 09:38:37.06 recv {\"errors\":{},\"values\":{\"time\":\"1640097517\"},\"inputMessages\":[]}"
  # [35] "{chromote}   JS info      09:38:37.06 shinytest2: value time"
  ...
  # [38] "{chromote}   JS info      09:38:40.03 shinytest2: busy"
  ...
  # [42] "{chromote}   JS info      09:38:40.03 shinytest2: idle"
  # [43] "{chromote}   JS websocket 09:38:40.04 recv {\"errors\":{},\"values\":{\"time\":\"1640097520\"},\"inputMessages\":[]}"
  # [44] "{chromote}   JS info      09:38:40.04 shinytest2: value time"
  ...
  # [47] "{chromote}   JS info      09:38:43.04 shinytest2: busy"
  ...
  # [51] "{chromote}   JS info      09:38:43.04 shinytest2: idle"
  # [52] "{chromote}   JS websocket 09:38:43.04 recv {\"errors\":{},\"values\":{\"time\":\"1640097523\"},\"inputMessages\":[]}"
  # [53] "{chromote}   JS info      09:38:43.04 shinytest2: value time"
  ...
  expect_match(log, "\\{chromote\\}   JS websocket \\d\\d:\\d\\d:\\d\\d.\\d\\d recv \\{\"busy\":\"idle\"\\}", all = FALSE)
